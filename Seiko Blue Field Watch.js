...
const createCheckoutModal = () => {
    ...
    modalContent.innerHTML = `
        ...
        <div style="margin-bottom: 20px; padding: 15px; background-color: #f8f5f0; border-radius: 8px; border-left: 4px solid #d69b40;">
            <h3 style="margin: 0 0 10px 0; color: #2b1d0e;">Seiko Blue Field Watch</h3>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Model: SRPG29</p>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Condition: 9.2/10 (pre-owned)</p>
        ...
        <form id="checkout-form">
            ...
            <div style="margin-bottom: 20px; padding: 10px; background-color: #e8f4f8; border-radius: 5px; font-size: 14px; color: #555;">
                <strong>Note:</strong> This is a pre-owned watch (9.2/10 condition). Price is slightly negotiable. 
...
document.addEventListener('submit', function(e) {
    if (e.target.id === 'checkout-form') {
        ...
        const orderData = {
            ...
            product: 'Seiko Blue Field Watch',
            model: 'SRPG29',
            condition: '9.2/10 (pre-owned)',
            price: '₱9,999'
        };
        ...
        setTimeout(() => {
            ...
            alert(`Thank you ${orderData.fullName}! Your order for the Seiko Blue Field Watch has been received. We'll contact you shortly at ${orderData.email} to confirm payment details and arrange ${locationText.toLowerCase()}.`);
            ...
            console.log('Blue Field Watch Order Data:', orderData);
        }, 2000);
    }
});
