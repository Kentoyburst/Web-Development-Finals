...
const createCheckoutModal = () => {
    ...
    modalContent.innerHTML = `
        ...
        <div style="margin-bottom: 20px; padding: 15px; background-color: #f0f8f5; border-radius: 8px; border-left: 4px solid #d69b40;">
            <h3 style="margin: 0 0 10px 0; color: #2b1d0e;">Seiko SKX Mid-Sized "TEAL"</h3>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Movement: 4R36 Automatic</p>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Condition: 9.8/10 (Brand New)</p>
            <p style="margin: 0; font-size: 18px; font-weight: bold; color: #d69b40;">₱13,999</p>
        </div>
        <form id="checkout-form">
            ...
            <div style="margin-bottom: 20px; padding: 10px; background-color: #e8f7fa; border-radius: 5px; font-size: 14px; color: #555;">
                <strong>Note:</strong> This is a brand new watch (9.8/10 condition). Price is slightly negotiable. 
                Includes: Watch, Full Links, and Actual Box. Mall price: ₱18,000.
            </div>
...
document.addEventListener('submit', function(e) {
    if (e.target.id === 'checkout-form') {
        ...
        const orderData = {
            ...
            product: 'Seiko SKX Mid-Sized "TEAL"',
            movement: '4R36 Automatic',
            condition: '9.8/10 (Brand New)',
            price: '₱13,999'
        };
        ...
        setTimeout(() => {
            ...
            alert(`Thank you ${orderData.fullName}! Your order for the Seiko SKX Mid-Sized "TEAL" has been received. We'll contact you shortly at ${orderData.email} to confirm payment details and arrange ${locationText.toLowerCase()}.`);
            ...
            console.log('Seiko Mid Teal Order Data:', orderData);
        }, 2000);
    }
});
