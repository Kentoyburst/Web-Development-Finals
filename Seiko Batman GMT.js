document.addEventListener('DOMContentLoaded', function() {
    ...
    if (addToCartBtn) {
        addToCartBtn.addEventListener('click', function() {
            const product = {
                ...
                product_id: 'ssk003k1', // Unique product identifier
                name: 'Seiko "Batman" GMT',
                price: 16999,
                image: 'img product/Seiko Batman GMT.jpg',
                specs: 'Model: SSK003K1, 9.4/10 condition',
                condition: 'Pre-owned'
            };
    ...
    console.log('Seiko Batman GMT Product Page Loaded Successfully');
...
const createCheckoutModal = () => {
    ...
    modalContent.innerHTML = `
        ...
        <div style="margin-bottom: 20px; padding: 15px; background-color: #f8f5f0; border-radius: 8px; border-left: 4px solid #d69b40;">
            <h3 style="margin: 0 0 10px 0; color: #2b1d0e;">Seiko "Batman" GMT</h3>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Model: SSK003K1</p>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Condition: 9.4/10 (pre-owned)</p>
            <p style="margin: 0; font-size: 18px; font-weight: bold; color: #d69b40;">₱16,999</p>
        </div>
        <form id="checkout-form">
            ...
            <div style="margin-bottom: 20px; padding: 10px; background-color: #e8f4f8; border-radius: 5px; font-size: 14px; color: #555;">
                <strong>Note:</strong> This is a pre-owned watch (9.4/10 condition). Price is slightly negotiable. 
                Includes: Watch, Extra Links, Manual, Booklet, Warranty Card, Actual Box, and Double Box.
            </div>
...
document.addEventListener('submit', function(e) {
    if (e.target.id === 'checkout-form') {
        ...
        const orderData = {
            ...
            product: 'Seiko "Batman" GMT',
            model: 'SSK003K1',
            condition: '9.4/10 (pre-owned)',
            price: '₱16,999'
        };
        ...
        setTimeout(() => {
            ...
            alert(`Thank you ${orderData.fullName}! Your order for the Seiko Batman GMT has been received. We'll contact you shortly at ${orderData.email} to confirm payment details and arrange ${locationText.toLowerCase()}.`);
            ...
            console.log('Batman GMT Order Data:', orderData);
        }, 2000);
    }
});
