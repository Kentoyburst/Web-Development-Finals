document.addEventListener('DOMContentLoaded', function() {
    ...
    if (addToCartBtn) {
        addToCartBtn.addEventListener('click', function() {
            const product = {
                ...
                product_id: 'skx007k', // Unique product identifier
                name: 'Original Seiko SKX007K',
                price: 11499,
                image: 'img product/Original Seiko SKX007K.jpg',
    ...
    console.log('Seiko SKX007K Product Page Loaded Successfully');
...
const createCheckoutModal = () => {
    ...
    modalContent.innerHTML = `
        ...
        <div style="margin-bottom: 20px; padding: 15px; background-color: #f8f5f0; border-radius: 8px; border-left: 4px solid #d69b40;">
            <h3 style="margin: 0 0 10px 0; color: #2b1d0e;">Original Seiko SKX007K</h3>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Movement: 7S26 Automatic</p>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Condition: Newly overhauled</p>
            <p style="margin: 0; font-size: 18px; font-weight: bold; color: #d69b40;">₱11,499</p>
        </div>
...
document.addEventListener('submit', function(e) {
    if (e.target.id === 'checkout-form') {
        ...
        const orderData = {
            ...
            product: 'Original Seiko SKX007K',
        ...
        setTimeout(() => {
            ...
            alert(`Thank you ${orderData.fullName}! Your order for the Original Seiko SKX007K has been received. We'll contact you shortly at ${orderData.email} to confirm payment details and arrange ${locationText.toLowerCase()}.`);
            ...
            console.log('SKX007K Order Data:', orderData);
        }, 2000);
    }
});
