document.addEventListener('DOMContentLoaded', function() {
    ...
    if (addToCartBtn) {
        addToCartBtn.addEventListener('click', function() {
            const product = {
                ...
                product_id: 'skx009j', // Unique product identifier
                name: 'Original Seiko SKX009J "PEPSI"',
                price: 9999,
                image: 'img product/Original Seiko SKX009J.jpg',
                specs: 'Caliber: 7S26, 21 Jewels, 200M Water Resistance',
    ...
    console.log('Seiko SKX009J Product Page Loaded Successfully');
...
const createCheckoutModal = () => {
    ...
    modalContent.innerHTML = `
        ...
        <div style="margin-bottom: 20px; padding: 15px; background-color: #f8f5f0; border-radius: 8px; border-left: 4px solid #d69b40;">
            <h3 style="margin: 0 0 10px 0; color: #2b1d0e;">Original Seiko SKX009J "PEPSI"</h3>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Movement: Automatic (Caliber 7S26)</p>
            <p style="margin: 5px 0; font-size: 14px; color: #666;">Condition: Newly overhauled, very good running condition</p>
            <p style="margin: 0; font-size: 18px; font-weight: bold; color: #d69b40;">₱9,999</p>
        </div>
        <form id="checkout-form">
            ...
            <div style="margin-bottom: 20px; padding: 10px; background-color: #e8f4f8; border-radius: 5px; font-size: 14px; color: #555;">
                ...
                Includes: Watch, Replacement Box, AM Jubilee Bracelet, Original Seiko Rubber Strap, Pin Bar Tool, 
                Strap Link Adjustment Tool, and New AM Bezel Insert. <strong>3 Months Free Service Warranty</strong> included.
            </div>
...
document.addEventListener('submit', function(e) {
    if (e.target.id === 'checkout-form') {
        ...
        const orderData = {
            ...
            product: 'Original Seiko SKX009J "PEPSI"',
            movement: 'Automatic (Caliber 7S26)',
            condition: 'Newly overhauled, very good running condition',
            price: '₱9,999'
        };
        ...
        setTimeout(() => {
            ...
            alert(`Thank you ${orderData.fullName}! Your order for the Seiko SKX009J "PEPSI" has been received. We'll contact you shortly at ${orderData.email} to confirm payment details and arrange ${locationText.toLowerCase()}. Your purchase includes our 3 Months Free Service Warranty!`);
            ...
            console.log('SKX009J Order Data:', orderData);
        }, 2000);
    }
});
